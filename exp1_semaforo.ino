...
(6S) AVISANDO QUE O SEMAFORO PARA PEDESTRES FICARA VERMELHO, APOS ISSO O SEMAFORO PARA PEDESTRES É FECHADO E ABERTO PARA OS CARROS,
VOLTANDO AO ESTADO INICIAL FOI IMPLEMENTADA UMA MAQUINA DE ESTADO ATRELADA A UM CONTADOR DE 0 A 23S QUE É ACIONADO POR UM 
